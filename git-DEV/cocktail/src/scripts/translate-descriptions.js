import connectDB from "../../lib/utils/mongodb.js";
import CocktailModel from "../../models/Cocktail.js";
    ...
    for (const cocktail of cocktails) {
      try {
        if (cocktail.description) {
          ...
          processed++;
          console.log(
            `[${processed}/${cocktails.length}] Description traduite avec succès`
          );
        }
        ...
        console.error(
          `Erreur lors du traitement de "${cocktail.name}":`,
          error
        );
      }
    }
